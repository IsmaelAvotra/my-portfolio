...
const Contact = () => {
  return (
    <>
      <div className='skills mt-8 px-4 tablet:px-8 mb-16 min-h-[80vh]'>
        <div className='title mb-8'>
          ...
          <p className='text-[15px] tablet:text-[16px]a'>
        ...
        <div className='form flex flex-col gap-4 tablet:gap-5 mb-10 tablet:mb-16'>
          <input
            type='text'
